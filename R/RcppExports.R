...
silero_vad <- function(path, vad_model, vad_threshold = 0.5, vad_min_speech_duration_ms = 250L, vad_min_silence_duration_ms = 100L, vad_max_speech_duration_s = -1, vad_speech_pad_ms = 30L, vad_samples_overlap = 0.1, use_gpu = TRUE, n_threads = 1L, probabilities = FALSE) {
